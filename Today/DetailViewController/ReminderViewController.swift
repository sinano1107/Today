...
class ReminderViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        dataSource = DataSource(collectionView: collectionView) {
            (collectionView: UICollectionView, indexPath: IndexPath, itemIdentifiable: Row) in
            return collectionView.dequeueConfiguredReusableCell(using: cellRegistration, for: indexPath, item: itemIdentifiable)
        }
        if #available(iOS 16, *) {
